package ro.fwd{
	...
	public class VideoScreenEvent extends Event {
		...
		public static const START_TO_BUFFER:String = "startToBuffer";
		public static const STOP_TO_BUFFER:String = "stopToBuffer";
		public static const VIDEO_COMPLETE:String = "playComplete";
		
		private var _text:String;
		private var _text2:String;
		private var _number:Number;

		public function VideoScreenEvent(pType:String, text:String=null, text2:String=null, number:Number = 0,  pBubbles:Boolean=false, pCancelable:Boolean=false) {
			this._text = text;
			this._text2 = text2;
			this._number = number;
		...
		override public function clone():Event {
			return new VideoScreenEvent(type, _text, _text2, _number, bubbles, cancelable);
		}
